...
func TestPersistentRegistrySQLSchemaContainsHostedPermissionStoreBoundary(t *testing.T) {
	...
	required := []string{
		...
		"hosted_permission_decisions_project_resolved_at",
		"hosted_permission_decisions_subject_resolved_at",
		"hosted_permission_decisions_created_at",
		"hosted_permission_decisions_policy_fingerprint",
		"hosted_permission_decisions_project_retain_until",
		"hosted_permission_decisions_project_visibility_time",
