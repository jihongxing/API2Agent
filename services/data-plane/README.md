...
- `API2AGENT_SNAPSHOT_RELOAD_POLICY` defaults to `startup_only`; set `manual` to enable `POST /v1/admin/reload-snapshot`. Failed reloads keep the previous snapshot active.
- `API2AGENT_EVENT_DIR`
