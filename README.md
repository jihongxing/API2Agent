...
Current focus: design OpenAPI server handling after closing security requirement combinations; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
