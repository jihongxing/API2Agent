...
Current focus: design OpenAPI security requirement combinations after closing examples/defaults propagation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
