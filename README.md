...
Current focus: live dogfood and closeout for the local hosted permission decision retention boundary implementation; next work remains API-first and out of public CRUD, OAuth/OIDC, vault, billing, marketplace, automatic propagation, production gateway deployment, and workflow runtime scope.
...
- [Agent Capability Compiler OpenAPI Response Shape Documentation Closeout + Phase Review](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_RESPONSE_SHAPE_DOCUMENTATION_CLOSEOUT_PHASE_REVIEW.md)
...
- [Agent Capability Compiler OpenAPI Real-Spec Calibration Implementation Report](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_REAL_SPEC_CALIBRATION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Real-Spec Calibration Closeout + Phase Review](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_REAL_SPEC_CALIBRATION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler Diagnostics Score Calibration Design](docs/en-US/AGENT_CAPABILITY_COMPILER_DIAGNOSTICS_SCORE_CALIBRATION_DESIGN.md)
- [Agent Capability Compiler Diagnostics Score Calibration Implementation Report](docs/en-US/AGENT_CAPABILITY_COMPILER_DIAGNOSTICS_SCORE_CALIBRATION_IMPLEMENTATION_REPORT.md)
...
- [Agent Capability Compiler OpenAPI Generic Example Reduction Design](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_DESIGN.md)
- [Agent Capability Compiler OpenAPI Generic Example Reduction Implementation Report](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Generic Example Reduction Closeout + Phase Review](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Design](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_DESIGN.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Implementation Report](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Closeout + Phase Review](docs/en-US/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler Final Re-entry Closeout + Consolidation Review](docs/en-US/AGENT_CAPABILITY_COMPILER_FINAL_REENTRY_CLOSEOUT_CONSOLIDATION_REVIEW.md)
...
- [Hosted Admin Gateway Permission Source Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_DESIGN.md)
- [Hosted Admin Gateway Permission Source Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_IMPLEMENTATION_REPORT.md)
- [Hosted Admin Gateway Permission Source Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_CLOSEOUT_PHASE_REVIEW.md)
- [Tenant-Partitioned Registry Mutation Design](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_DESIGN.md)
- [Tenant-Partitioned Registry Mutation Contract Harness Implementation Report](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_CONTRACT_HARNESS_IMPLEMENTATION_REPORT.md)
- [Tenant-Partitioned Registry Mutation Contract Harness Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_CONTRACT_HARNESS_CLOSEOUT_PHASE_REVIEW.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Design](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_DESIGN.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Implementation Report](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_IMPLEMENTATION_REPORT.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Live Dogfood + Closeout](docs/en-US/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_LIVE_DOGFOOD_CLOSEOUT.md)
- [Hosted Permission Store Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_DESIGN.md)
- [Hosted Permission Store Contract Harness Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_CONTRACT_HARNESS_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Contract Harness Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_CONTRACT_HARNESS_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Schema Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_SCHEMA_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Schema Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_SCHEMA_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Read Model Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Read Model Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Read Model Live Postgres Dogfood Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_LIVE_POSTGRES_DOGFOOD_REPORT.md)
- [Hosted Permission Store Read Model Live Postgres Dogfood Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_LIVE_POSTGRES_DOGFOOD_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Read Model Gateway Runtime Wiring Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_DESIGN.md)
- [Hosted Permission Read Model Gateway Runtime Wiring Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Read Model Gateway Runtime Wiring Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_DESIGN.md)
- [Hosted Permission Decision Persistence Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Decision Persistence Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Integrity Hardening Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_DESIGN.md)
- [Hosted Permission Decision Persistence Integrity Hardening Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Decision Persistence Integrity Hardening Closeout + Phase Review](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Production Boundary Design](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_PRODUCTION_BOUNDARY_DESIGN.md)
...
- [Hosted Permission Decision Retention Boundary Implementation Report](docs/en-US/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_RETENTION_BOUNDARY_IMPLEMENTATION_REPORT.md)
...
- [Agent Capability Compiler OpenAPI Response Shape Documentation Closeout + Phase Review](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_RESPONSE_SHAPE_DOCUMENTATION_CLOSEOUT_PHASE_REVIEW.md)
...
- [Agent Capability Compiler OpenAPI Real-Spec Calibration Implementation 报告](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_REAL_SPEC_CALIBRATION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Real-Spec Calibration Closeout + Phase Review](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_REAL_SPEC_CALIBRATION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler Diagnostics Score Calibration Design](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_DIAGNOSTICS_SCORE_CALIBRATION_DESIGN.md)
- [Agent Capability Compiler Diagnostics Score Calibration Implementation 报告](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_DIAGNOSTICS_SCORE_CALIBRATION_IMPLEMENTATION_REPORT.md)
...
- [Agent Capability Compiler OpenAPI Generic Example Reduction Design](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_DESIGN.md)
- [Agent Capability Compiler OpenAPI Generic Example Reduction Implementation 报告](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Generic Example Reduction Closeout + Phase Review](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_GENERIC_EXAMPLE_REDUCTION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Design](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_DESIGN.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Implementation 报告](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_IMPLEMENTATION_REPORT.md)
- [Agent Capability Compiler OpenAPI Cached Real-Spec Corpus Expansion Closeout + Phase Review](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_OPENAPI_CACHED_REAL_SPEC_CORPUS_EXPANSION_CLOSEOUT_PHASE_REVIEW.md)
- [Agent Capability Compiler Final Re-entry Closeout + Consolidation Review](docs/cn-ZH/AGENT_CAPABILITY_COMPILER_FINAL_REENTRY_CLOSEOUT_CONSOLIDATION_REVIEW.md)
...
- [Hosted Admin Gateway Permission Source Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_DESIGN.md)
- [Hosted Admin Gateway Permission Source Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_IMPLEMENTATION_REPORT.md)
- [Hosted Admin Gateway Permission Source Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_ADMIN_GATEWAY_PERMISSION_SOURCE_CLOSEOUT_PHASE_REVIEW.md)
- [Tenant-Partitioned Registry Mutation Design](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_DESIGN.md)
- [Tenant-Partitioned Registry Mutation Contract Harness Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_CONTRACT_HARNESS_IMPLEMENTATION_REPORT.md)
- [Tenant-Partitioned Registry Mutation Contract Harness Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_CONTRACT_HARNESS_CLOSEOUT_PHASE_REVIEW.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Design](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_DESIGN.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_IMPLEMENTATION_REPORT.md)
- [Tenant-Partitioned Registry Mutation Private Endpoint Live Dogfood + Closeout](docs/cn-ZH/GO_CONTROL_PLANE_TENANT_PARTITIONED_REGISTRY_MUTATION_PRIVATE_ENDPOINT_LIVE_DOGFOOD_CLOSEOUT.md)
- [Hosted Permission Store Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_DESIGN.md)
- [Hosted Permission Store Contract Harness Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_CONTRACT_HARNESS_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Contract Harness Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_CONTRACT_HARNESS_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Schema Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_SCHEMA_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Schema Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_SCHEMA_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Read Model Implementation 报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Store Read Model Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Store Read Model Live Postgres Dogfood 报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_LIVE_POSTGRES_DOGFOOD_REPORT.md)
- [Hosted Permission Store Read Model Live Postgres Dogfood Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_STORE_READ_MODEL_LIVE_POSTGRES_DOGFOOD_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Read Model Gateway Runtime Wiring Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_DESIGN.md)
- [Hosted Permission Read Model Gateway Runtime Wiring 实现报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Read Model Gateway Runtime Wiring Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_READ_MODEL_GATEWAY_RUNTIME_WIRING_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_DESIGN.md)
- [Hosted Permission Decision Persistence 实现报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Decision Persistence Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Integrity Hardening Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_DESIGN.md)
- [Hosted Permission Decision Persistence Integrity Hardening 实现报告](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_IMPLEMENTATION_REPORT.md)
- [Hosted Permission Decision Persistence Integrity Hardening Closeout + Phase Review](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_INTEGRITY_HARDENING_CLOSEOUT_PHASE_REVIEW.md)
- [Hosted Permission Decision Persistence Production Boundary Design](docs/cn-ZH/GO_CONTROL_PLANE_HOSTED_PERMISSION_DECISION_PERSISTENCE_PRODUCTION_BOUNDARY_DESIGN.md)
