...
Current focus: implement OpenAPI security requirement combinations after design; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
