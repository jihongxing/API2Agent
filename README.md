...
Current focus: design the trusted-gateway hosted admin production boundary for the Go Control Plane; next work remains out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
