...
Current focus: design OpenAPI schema shaping after closing server handling; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
