...
Current focus: design diagnostics score calibration for the Agent Capability Compiler after closing the OpenAPI real-spec calibration harness; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
