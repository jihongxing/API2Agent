...
Current focus: perform the final Agent Capability Compiler re-entry closeout and consolidation review after closing cached real-spec corpus expansion; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
