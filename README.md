...
Current focus: design OpenAPI discriminator handling after closing schema shaping; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
