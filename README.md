...
Current focus: implement the hosted permission decision persistence production boundary after completing the design; next work remains API-first and out of public CRUD, OAuth/OIDC, vault, billing, marketplace, automatic propagation, production gateway deployment, and workflow runtime scope.
