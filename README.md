...
Current focus: design OpenAPI summary noise reduction for the Agent Capability Compiler after closing diagnostics score calibration; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
