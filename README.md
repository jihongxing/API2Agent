...
Current focus: implement OpenAPI examples/defaults propagation after the real-world hardening design; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
