...
Current focus: design cached real-spec corpus expansion for the Agent Capability Compiler after closing OpenAPI generic example reduction; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
