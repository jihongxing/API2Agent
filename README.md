...
Current focus: close out bounded OpenAPI JSON Schema keyword coverage after implementation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
