...
Current focus: close out OpenAPI generic example reduction for the Agent Capability Compiler after completing the implementation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
