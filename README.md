...
Current focus: implement bounded OpenAPI JSON Schema keyword coverage after completing the design; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
