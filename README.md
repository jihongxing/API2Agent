...
Current focus: close out diagnostics score calibration for the Agent Capability Compiler after completing the implementation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
