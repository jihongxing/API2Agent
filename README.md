...
Current focus: design bounded OpenAPI JSON Schema keyword coverage after closing response shape documentation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
