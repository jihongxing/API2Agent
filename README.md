...
Current focus: implement diagnostics score calibration for the Agent Capability Compiler after completing the design; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
