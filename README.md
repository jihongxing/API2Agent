...
Current focus: close out OpenAPI security requirement combinations after implementation; next work remains API-first and out of public CRUD, vault, billing, marketplace, automatic propagation, and workflow runtime scope.
